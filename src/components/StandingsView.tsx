        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border/60 bg-muted/30">
              <th className="text-left py-2.5 px-4 font-semibold text-muted-foreground text-xs uppercase tracking-wider w-8">#</th>
              ...
              {onToggleFavTeam && <th className="w-10" />}
            </tr>
          </thead>
          <tbody>
            {teams.map((team, i) => {
              ...
              return (
                ...
                >
                  <td className="py-2.5 px-4 tabular-nums text-muted-foreground font-medium">{i + 1}</td>
                  ...
                  {onToggleFavTeam && (
                    <td className="py-2.5 px-2 text-center">
                      ...
                      >
                        <Star className={`h-3.5 w-3.5 transition-colors ${isFav ? 'fill-yellow-500 text-yellow-500' : 'text-muted-foreground/40'}`} />
                      </button>
                    </td>
                  )}
                </motion.tr>
